...
SAAS = profile(
    ...
    multi_page_links=(
        ...
        LinkRule("Company", "Contact", LinkType.NAVIGATION),
    ),
)
...
ECOMMERCE = profile(
    ...
    multi_page_links=(
        ...
        LinkRule("Product", "Product", LinkType.NAVIGATION),
...
TRAVEL = profile(
    ...
    multi_page_links=(
        ...
        LinkRule("Destination", "Experience", LinkType.NAVIGATION),
        LinkRule("Destination", "Itinerary", LinkType.NAVIGATION),
        LinkRule("Experience", "Destination", LinkType.NAVIGATION),
        LinkRule("Experience", "Booking", LinkType.CTA),
        LinkRule("Itinerary", "Booking", LinkType.CTA),
        LinkRule("Journal", "Destination", LinkType.NAVIGATION),
    ),
)
...
TECHNOLOGY = profile(
    ...
    multi_page_links=(
        ...
        LinkRule("Product", "Documentation", LinkType.CTA),
